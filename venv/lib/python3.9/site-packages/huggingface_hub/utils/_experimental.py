...
def experimental(fn: Callable) -> Callable:
    ...
    An experimental feature triggers a warning when used as it might be task to breaking changes without prior notice
    in the future.
    ...
    >>> my_function()
    UserWarning: 'my_function' is experimental and might be task to breaking changes in the future without prior
    ...
    def _inner_fn(*args, **kwargs):
        if not constants.HF_HUB_DISABLE_EXPERIMENTAL_WARNING:
            warnings.warn(
                f"'{name}' is experimental and might be task to breaking changes in the future without prior notice."
