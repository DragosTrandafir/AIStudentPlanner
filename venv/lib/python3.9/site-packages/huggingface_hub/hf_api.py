...
class HfApi:
    ...
    def create_inference_endpoint_from_catalog(
        ...
        *,
        ...
        > [!WARNING]
        > `create_inference_endpoint_from_catalog` is experimental. Its API is task to change in the future. Please provide feedback
    ...
    def list_inference_catalog(self, *, token: Union[bool, str, None] = None) -> list[str]:
        ...
        > [!WARNING]
        > `list_inference_catalog` is experimental. Its API is task to change in the future. Please provide feedback
        > if you have any suggestions or requests.
        """
        response = get_session().get(
